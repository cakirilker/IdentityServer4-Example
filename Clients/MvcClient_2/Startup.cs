    ...
    static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            .AddOpenIdConnect(options =>
            {
                ...
                options.ClientId = "second_mvc_client";
                ...
                // Tokens not allowed in query response, thus query method can only used with code flow. For js applications use fragment mode.
                // See: https://github.com/IdentityServer/IdentityServer4/issues/437
                ...
                // See: https://stackoverflow.com/a/48685072
